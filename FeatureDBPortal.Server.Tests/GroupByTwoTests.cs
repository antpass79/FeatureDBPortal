...
namespace FeatureDBPortal.Server.Tests
{
    public class GroupByTwoTests : BaseGroupByTests
    {
        ...
        protected override ICombinationGroupService BuildCombinationGroupService()
        {
            ...
            return new CombinationGroupByTwoService(context, new VersionProvider(context), new GroupProviderBuilder(new AllowModeProvider(context), new FilterCache(), new CombinationIndexerBuilder()));
        }
