...
namespace FeatureDBPortal.Server.Tests
{
    public class GroupByOneTests : BaseGroupByTests
    {
        ...
        protected override ICombinationGroupService BuildCombinationGroupService()
        {
            ...
            return new CombinationGroupByOneService(context, new VersionProvider(context), new GroupProviderBuilder(new AllowModeProvider(context), new FilterCache(), new CombinationIndexerBuilder()));
        }
